...
// ---------------------------------------------
  ...
  $cmd ="SELECT * FROM Societe where IdSociete= ".$id."";
 ...
 <div class="row" style="margin-bottom: 23px;">
    <div class="col-12">             
      <div style ="background: rgba(82, 95, 127, 0.05);border-radius: .375rem;border-top-left-radius: 0.375rem;border-bottom-left-radius: 0.375rem; margin-bottom: 12px;margin-top: -35px">
          <p style="text-align: center;padding-top: 10px;padding-bottom: 10px;font-weight: bold;"><i class="fas fa-map-signs"></i> Les informations suivantes seront organisées comme suit<br> Année <i class="fas fa-arrow-right"></i> Produit <i class="fas fa-arrow-right"></i> Documents(PDF)</p>                    
      </div>                
    </div>            
  </div>
        ...
        <div class="row">
          <div class="col-md-10">            	
              ...
              <ol class="breadcrumb" style="background-color:white">
            		<a href="company.php"><i class="fas fa-arrow-left"></i></a>
              		  &nbsp;&nbsp;&nbsp;
                <i class="far fa-calendar-alt" style="margin-top: 4px;"></i>
                    &nbsp;&nbsp;&nbsp;                                     
                <li class="breadcrumb-item active" aria-current="page"><?= $_GET['NOM']; ?></li>
              </ol>
          	</h3>
          </div>
          <div class="col-md-2">
              ...
              <!-- Modal -->
				  <div class="modal fade" id="myModal" role="dialog">
				    <div class="modal-dialog" style="margin-top: 7%;">
				      <form method="post" action="Function/AddFolderInSociete.php" id="my_form">
				      <!-- Modal content-->
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="Année">Ajouter une nouvelle année</label>
                        <input type="number" id="Année" name="Année" class="form-control" placeholder="Année" required>
                      </div>
      ...
      if (file_exists($file_pointer)) {
        ...
        for ($i=0; $i < count($results_array); $i++) { 
          ...
          ?>
            ...
            ?>
           <a href="ConsultationProduit.php?Year=<?= $results_array[$i]?>">
            ...
            //copy
              ...
              actions: [{
               name: '<a style="color:rgba(0, 0, 0, .5);" href="#"><i class="fas fa-folder-open"></i>&nbsp;&nbsp;&nbsp;Open</a>',
                onClick: function() {
                 window.location.href = "ConsultationProduit.php?Year=<?= $results_array[$i]?>";
                }
                }, {
                name: '<a style="color:rgba(0, 0, 0, .5);" href="#"><i class="fas fa-link"></i>&nbsp;&nbsp;&nbsp;obtenir le lien</a>',
                onClick: function() {
                 copyStringToClipboard("<?="http".(($_SERVER['SERVER_PORT'] == 443) ? "s" : "")."://".$_SERVER['HTTP_HOST']?>/<?=$db['Folder_Container']?>/ConsultationProduit.php?Year=<?= $results_array[$i]?>");
                }
                }, {
